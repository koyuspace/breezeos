; ------------------------------------------------------------------
; Minicom-like program for BreezeOS
; ------------------------------------------------------------------
...
;
; Connect the serial cable to your BreezeOS machine and Linux machine.
; Start BreezeOS and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the BreezeOS machine, you will see a
...
erase_sub:
	...
	start_msg	db 'Breeze OS minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting Breeze OS minicom; press a key to return to Breeze OS', 13, 10, 0
