...
; *         Copyright (C) 2014 BreezeOS Developers -- see doc/LICENSE.TXT
; *
...
org	0x8000		; Start 1/2 way through segment for BreezeOS
...
start_forth:
	dw      CR, CR, dotq
	db      sf01 - $ - 1
	db      'Copyright (C) 2014 BreezeOS Developers -- see doc/LICENSE.TXT'
  sf01:
	dw      CR, dotq
	db      sf02 - $ - 1
	db      'FORTH version '
