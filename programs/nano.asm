...
crash:
	...
	crash_msg			db "nano has crashed :(", 13, 10
	db 'You can report this bug by putting a bug report on the BreezeOS Forum or email:'
...
draw_cmd:
	...
	name_and_version		db 	'nano ', VERSION_STRING, 0
