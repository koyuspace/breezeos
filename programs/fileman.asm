; ------------------------------------------------------------------
; Simple file manager for BreezeOS: copy, delete and rename files
; ------------------------------------------------------------------
	...
	; This is the point used by the disk buffer in the BreezeOS kernel
...
.draw_background:
	...
	.title_msg		db 'Breeze OS File Manager', 0
