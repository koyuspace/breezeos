...
The length is important for our Self-Modifying Code
...
Requires Breeze OS 1.0 or better.
...
INTRO:
  ...
  PRINT "BreezeBASIC Interactive Interpreter"
...
HELP:
  ...
  PRINT "You can use ':' to seperate multiple commands"
