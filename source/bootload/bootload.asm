...
; Copyright (C) 2006 - 2014 BreezeOS Developers -- see doc/LICENSE.TXT
;
; Based on a free boot loader by E Dehling. It scans the FAT12
; floppy for KERNEL.BIN (the BreezeOS kernel), loads it and executes it.
...
; 
; We actually use the older BreezeOS bootloader code here, because it
; works far better than the new one. Still we're not sure if this is
; the right code for now, it will eventually change if we figured out
; what the code will look like if we are keen enough to rewrite it.
; But for now: if it works don't change it.
; ==================================================================
...
OEMLabel		db "BREEZEOS"	; Disk label
...
VolumeLabel		db "BREEZEOS"; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; BreezeOS kernel filename
